...
const AdminLunchReport = () => {
        ...
        const fetchReport = async () => {
            try {
                const res = await fetch(
                    `${process.env.REACT_APP_BACKEND_URL}/admin/lunch-report`,
                    {
                        headers: {
                ...
                if (!data.success) {
                    message.warning(data.message || "Lunch report not available yet.");
                } else {
                ...
                message.error("Failed to load lunch report.");
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleTableChange = (pagination, filters) => {
        ...
        // ✅ Update filtered report dynamically
    ...
    const getColumnSearchProps = (dataIndex, label) => ({
        ...
        filterIcon: (filtered) => (
            <SearchOutlined style={{ color: filtered ? "#fa8c16" : undefined }} />
        ),
        filterDropdownProps: {
            ...
            render: (photo) => (
                <Avatar
                    ...
                    style={{
                        ...
                        boxShadow: "0 0 6px rgba(250,140,22,0.4)",
                        cursor: "pointer",
        ...
        <div className="relative p-2 sm:p-4 md:p-8 min-h-screen flex justify-center items-start">
            <Card
                style={{
                    ...
                    maxWidth: "1200px",
                    borderRadius: "20px",
                    boxShadow: "0 6px 20px rgba(250,140,22,0.15)",
                    padding: "16px",
                    overflow: "hidden",
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6 text-center">
                    <h2
                        ...
                        style={{
                            color: "#fa8c16",
                            borderBottom: "3px solid #d46b08",
                            display: "inline-block",
                            paddingBottom: "6px",
                        }}
                    >
                        Lunch Attendance Report ({filteredReport.length})
                    </h2>
                    ...
                    <Button
                        ...
                        style={{
                            ...
                            fontWeight: 500,
                            height: "42px",
                            boxShadow: "0 0 8px rgba(250,140,22,0.2)",
                        }}
                    >
                        Clear All Filters
                    </Button>
                ...
                <style jsx="true">{`
                    ...
                    .ant-table-thead > tr > th {
                        ...
                        font-size: 15px;
                        white-space: nowrap;
                        border-bottom: 2px solid #ffa940 !important;
                    }
                    ...
                    .ant-table-filter-trigger {
                        box-shadow: 0 0 6px 0.5px brown;
...
export default AdminLunchReport;
